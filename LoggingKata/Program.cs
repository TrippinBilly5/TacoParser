...
namespace LoggingKata
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            var miles = Math.Round(distance / 1609.34708789, 2);
            logger.LogInfo($"The two Taco Bells the furthest from each other are {tacoBell1.Name} and {tacoBell2.Name}." +
                $"  The distance is {miles} miles.");
